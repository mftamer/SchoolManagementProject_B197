...
public class AddDeanPage {
    ...
    @FindBy(xpath = "//div[@class='offcanvas offcanvas-start show']/div[@class='offcanvas-body']")
    public WebElement mainMenuBodyForStudent;
    @FindBy(id = "username")
    ...
    public WebElement editDeanSubmit;
    @FindBy (xpath = "//div[@class='modal-footer']/button[@class='fw-semibold btn btn-primary btn-lg']")
    public WebElement deanUpdatedUyari;
    ...
    @FindBy (xpath ="//div[@class='Toastify__toast-body']/div[contains(.,'JSON parse error: Cannot deserialize value of type `java.time.LocalDate` from St')]")
    ...
    public WebElement deanListName;
    @FindBy (xpath ="//th[.='Gender']")
    public WebElement deanListGender;
    @FindBy (xpath ="//th[.='Phone Number']")
    public WebElement deanListPhone;
    @FindBy (xpath ="//th[.='Ssn']")
    public WebElement deanListSSN;
    @FindBy (xpath ="//th[.='User Name']")
    public WebElement deanListUserName;
    @FindBy (xpath ="//h5[.='Dean List']")
    public WebElement deanListisDisplayed;
    @FindBy (xpath ="//tr[6]//button[@class='text-dark btn btn-outline-info']")
    ...
    public WebElement tableNameLastCell;
    @FindBy(xpath = "//table//tr[last()]//td[6]")
    public WebElement tableLAstCellEdit;
    @FindBy(xpath = "//div[@class='Toastify__toast-body']/div[.='Your name must consist of the characters .']")
    public WebElement nameRequiresCharacterPopUp;
    @FindBy(xpath = "//div[@class='Toastify__toast-body']/div[.='Your surname must consist of the characters .']")
    public WebElement surNameRequiresCharacterPopUp;
    @FindBy(xpath = "//div[@class='Toastify__toast-body']/div[.='Your name should be at least 2 characters']")
    public WebElement deanNameContainsAtLeastTwoCharsPopUp;
    @FindBy(xpath = "//div[@class='Toastify__toast-body']/div[.='Your birth place must consist of the characters .']")
    public WebElement birthPlaceRequiresCharacterPopUp;
    @FindBy(xpath = "//div[@class='Toastify__toast-body']/div[.='Your surname should be at least 2 characters']")
    public WebElement surNameContainsAtLeastTwoCharsPopUp;
    @FindBy(xpath = "//div[@class='Toastify__toast-body']/div[.='Your birth place should be at least 2 characters']")
    public WebElement birthPlaceContainsAtLeastTwoCharsPopUp;
